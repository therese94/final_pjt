"""
Django settings for JunesMovie project.
...
SECRET_KEY = '$bm*_f=$#auyrr=j3(a_@j7r5mp7(pp3%k(v4!%$%ke+sf--@)'
...
WSGI_APPLICATION = 'JunesMovie.wsgi.application'
